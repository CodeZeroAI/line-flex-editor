    ...
    render() {
        return (
            <div className={'flex-tooltip-section'}>
                <label className={'flex-tooltip-label'}>{this.props.prefix} background color</label>
                ...
                />
                <label className={'flex-tooltip-label'}>{this.props.prefix} separator Color</label>
                <ToggleButton defaultValue={this.props.json.separator || false} onChange={this.onSeparatorToggle}/>
